    ...
    return (
        <div className="mx-auto md:max-w-xl lg:max-w-screen-xl grid gap-8 grid-cols-2 lg:grid-cols-4">
            <div className="text-center">
                ...
                <h6 className="text-base sm:text-2xl lg:text-4xl font-bold text-cyan-800">5+</h6>
            ...
            <div className="text-center">
                ...
                <h6 className="text-base sm:text-2xl lg:text-4xl font-bold text-indigo-400">4+</h6>
            ...
            <div className="text-center">
                ...
                <h6 className="text-base sm:text-2xl lg:text-4xl font-bold text-green-700">80%</h6>
            ...
            <div className="text-center">
                ...
                <h6 className="text-base sm:text-2xl lg:text-4xl font-bold text-orange-900">2.5+</h6>
