...
const programs = [
    { name: 'Bachelors', description: 'Study Bachelors in Germany', href: 'https://study.gov.pl/', icon: AcademicCapIcon },
    { name: 'Masters', description: 'Study Masters and find Work in poland', href: 'https://study.gov.pl/', icon: BuildingLibraryIcon },
    { name: 'PhD', description: 'Start your Dream PhD Career after Masters', href: 'https://study.gov.pl/', icon: BriefcaseIcon },
]
const callsToAction = [
    { direct: 'Go To Programs ->', href: 'https://study.gov.pl/', icon: QueueListIcon },
]
                ...
                <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <Link to="/" className="-m-1.5 p-1.5">
                            <span className="sr-only">Arasta</span>
                            <img
                                className="h-12 sm:h-14 w-auto lg:hidden"
                                src={brandiconmd}
                                alt="brandlogo"
                                />
