    ...
    return (
        <div className="flex flex-col mx-auto space-y-12">
            <div className="relative">
                ...
                <p className="w-full py-8 mx-auto -mt-2 subdesc text-center sm:max-w-3xl">We are a trusted travel and education consultancy, helping students and travelers access global opportunities. From university admissions and scholarships to visas and travel services, we guide you every step of the way.</p>
            </div>
